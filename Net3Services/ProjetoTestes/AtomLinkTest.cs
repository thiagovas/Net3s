...
namespace ProjetoTestes
{
    ...
    public class AtomLinkTest
    {
        ...
        /// <summary>
        ///A test for AttributeHref
        ///</summary>
        [TestMethod()]
        public void AttributeHrefTest()
        {
            AtomLink target = new AtomLink(); // TODO: Initialize to an appropriate value
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            target.AttributeHref = expected;
            actual = target.AttributeHref;
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }

        /// <summary>
        ///A test for AttributeRel
        ///</summary>
        [TestMethod()]
        public void AttributeRelTest()
        {
            AtomLink target = new AtomLink(); // TODO: Initialize to an appropriate value
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            target.AttributeRel = expected;
            actual = target.AttributeRel;
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }

        /// <summary>
        ///A test for AttributeType
        ///</summary>
        [TestMethod()]
        public void AttributeTypeTest()
        {
            ...
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            target.AttributeType = expected;
            actual = target.AttributeType;
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
    }
