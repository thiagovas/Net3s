...
namespace ProjetoTestes
{
    ...
    /// <summary>
    ///This is a test class for ClsCatalogoEnderecosDALTest and is intended
    ///to contain all ClsCatalogoEnderecosDALTest Unit Tests
    ///</summary>
    [TestClass()]
    public class ClsCatalogoEnderecosDALTest
    {
        ...
        /// <summary>
        ///A test for ClsCatalogoEnderecosDAL Constructor
        ///</summary>
        [TestMethod()]
        public void ClsCatalogoEnderecosDALConstructorTest()
        {
            ClsCatalogoEnderecosDAL target = new ClsCatalogoEnderecosDAL();
        ...
        {
            ClsCatalogoEnderecosDAL target = new ClsCatalogoEnderecosDAL(); // TODO: Initialize to an appropriate value
