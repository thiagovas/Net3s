        ...
        private void BuscarOrcamentos(string tipo)
        {
            ...
            if (LstOrcam != null)
            {
                ...
                LstOrcam.ForEach(delegate(Orcamento o)
                {
                    ...
                    Contratante = usuBLL.BuscarUsuarioPorID(o.contratate);

                    //Aqui ele gera a imagem de acordo com a informação de nome
                    if (usuBLL.VerificarImagem(o.contratate.ToString()))
                        nomeFoto = o.contratate.ToString();
                    else
                        nomeFoto = "1";
                    ...
                    //Gerando todo HTML
                    div.InnerHtml += string.Format("<a href='ResponderOrcamento.aspx?id={0}' class='orcamento'><div class='atualizacao'>", o.contratate);
