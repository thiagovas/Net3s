<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contratar.aspx.cs" Inherits="UI.User.Contratar" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#contratar').click(function () {
                $.ajax({
                    type: "POST",
                    url: "Contratar.aspx/ContratarServico",
                    data: "{}",
...
<body>
    <form id="frmContratar" runat="server">
    <div id="tudo">
        <div id="cabecalho">
            <label class="titulo">
                Contratar Serviço</label>
        ...
        <div id="corpo">
            ...
            <div style="text-align: right">
                 <a id="contratar" class="btn">Contratar</a>
