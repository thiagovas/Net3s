            ...
            <div class="st-container">
                ...
                <div class="st-scroll">
                    <section class="st-panel" id="st-panel-1">
				        <div class="st-deco" data-icon="L"></div>
  					    <div id="login">
                            ...
                            &nbsp;Lembrar-me
  						    <label><asp:LinkButton ID="btnEsqueciSenha" Enabled="true" ToolTip="Esqueci minha senha" TabIndex="5" runat="server" Text="Esqueci minha senha" OnClick="btnEsqueciSenha_Click"></asp:LinkButton></label>
  					    </div>
                    ...
                    <section class="st-panel st-color" id="st-panel-2">
                        ...
                        <asp:UpdatePanel ID="upCadUsuario" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <div id="cadastro">
                                    ...
                                    <div id="btnCad">
                                        <asp:LinkButton ID="btnCadastrar" runat="server" CssClass="button" TabIndex="16" onclick="lbCadastrar_Click">Cadastrar</asp:LinkButton>
                                    </div>
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
