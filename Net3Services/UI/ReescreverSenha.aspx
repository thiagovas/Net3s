<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReescreverSenha.aspx.cs" Inherits="UI.ReescreverSenha" %>
                ...
                <section class="st-panel" id="st-panel-1">
				    <div class="st-deco" data-icon="7"></div>
  					...
  					<div id="RecSenha">
                        ...
                        <asp:TextBox ID="txtSenha" runat="server" placeHolder="Nova senha" TabIndex="0"></asp:TextBox><br />
                        
                        <label>Reescrever senha: </label>
                        <asp:TextBox ID="txtNovaSenha" runat="server" placeHolder="Reescrever senha" TabIndex="1"></asp:TextBox><br />
                        
                        <asp:Button ID="btnSalvar" runat="server" Text="Recuperar" CssClass="button" 
                                            TabIndex="2" onclick="btnSalvar_Click"/>
                        <br />
