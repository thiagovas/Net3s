    ...
    <asp:UpdatePanel ID="upConteudo" runat="server">
        <ContentTemplate>
            ...
            <header>
              ...
              <p>
                <asp:LinkButton ID="btnAddToNetwork" CssClass="nbutton" runat="server" Visible="true"><i class="icon-plus"></i>Adicionar</asp:LinkButton>
                <a id="solicitarOrcamento" class="nbutton" runat="server" href="SocilicarOrcamento.aspx?id=<%= this.usu %>"><i class="icon-file-alt"></i>Solicitar Orçamento</a>
                <asp:HyperLink ID="hlEditar" CssClass="nbutton" runat="server"><i class="icon-edit"></i>Editar Perfil</asp:HyperLink>
              </p>
            </header>
            <br />
            <div id="info">
