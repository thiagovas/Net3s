...
namespace Chrisimos.Validacoes
{
    /// <summary>
    /// Classe que contém algoritmos para validar alguns tipos de documentos.
    /// </summary>
    public class ValidaDocumentos
    {
        /// <summary>
        /// Método que tem a função de validar cpf.
        /// </summary>
        /// <param name="cpf">CPF a ser validado.</param>
        /// <returns>Retorna true se o CPF for valido, e false se o CPF for inválido.</returns>
        ...
        public static bool ValidarCpf(string cpf)
        {
            ...
            retorno = calculado == digitado ? true : false;

            return retorno;
        }

        /// <summary>
        /// Método que tem a função de validar CNPJ.
        /// </summary>
        /// <param name="cnpj">CNPJ a ser validado.</param>
        /// <returns>Retorna true se o cnpj for válido e false se o cnpj for inválido.</returns>
        /// <by>Thiago Vieira - t.vas@hotmail.com</by>
        public static bool ValidarCnpj(string cnpj)
        {
            ...
            digitoVer1 = soma % 11 > 2 ? 11 - (soma % 11) : 0;
            ...
            digitoVer2 = soma % 11 > 2 ? 11 - (soma % 11) : 0;

            #endregion

            return (digitoVer1.ToString() + digitoVer2.ToString()) == cnpj.Substring(12, 2) ? true : false;
        }

        /// <summary>
        /// Método responsável por validar número de cartão de crédito.
        /// </summary>
        /// <param name="numero">Número do cartão de crédito a ser validado.</param>
        /// <returns>Retorna uma variável do tipo Booleana, sendo true se o número do cartão for válido e false se for inválido.</returns>
        public bool ValidarCartaoCredito(string numero)
        {
